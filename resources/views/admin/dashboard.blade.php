    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
        ...
        <div class="stat-card">
            ...
            <div class="mt-4 pt-4 border-t border-surface-200 dark:border-surface-700">
                <a href="{{ route('admin.servers.index') }}" class="text-sm font-medium text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 inline-flex items-center gap-1">
                    {{ __('app.view_all') }}
        ...
        <div class="stat-card">
            ...
            <div class="mt-4 pt-4 border-t border-surface-200 dark:border-surface-700">
                <a href="{{ route('admin.nat-vps.index') }}" class="text-sm font-medium text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 inline-flex items-center gap-1">
                    {{ __('app.view_all') }}
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                    </svg>
        ...
        <div class="stat-card">
            ...
            <div class="mt-4 pt-4 border-t border-surface-200 dark:border-surface-700">
                <a href="{{ route('admin.users.index') }}" class="text-sm font-medium text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 inline-flex items-center gap-1">
                    {{ __('app.view_all') }}
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                    </svg>
    ...
    <div class="card mb-8">
        ...
        <div class="card-body space-y-3">
            ...
            <div class="flex items-center justify-between p-4 rounded-xl {{ $issue['severity'] === 'error' ? 'bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800' : 'bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800' }}">
                ...
                <a href="{{ route('admin.servers.edit', $issue['server']) }}" class="btn btn-sm btn-ghost">
                    {{ __('app.view') }}
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                    </svg>
