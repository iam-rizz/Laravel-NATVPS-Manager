            ...
            <div class="p-6">
                @if($natVpsList->isEmpty())
                        <div class="text-center py-8">
                            ...
                            <div class="mt-6">
                                <a href="{{ route('vps.create') }}" class="inline-flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium rounded-lg bg-primary-600 text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all duration-150">
                                    {{ __('app.add_nat_vps') ?? 'Add NAT VPS' }}
                                </a>
                            </div>
                        </div>
                                        ...
                                        <tr class="hover:bg-surface-50 dark:hover:bg-surface-700/50 transition-colors">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex justify-end gap-2">
                                                    ...
                                                    <a href="{{ route('vps.edit', $natVps) }}" class="p-2 text-primary-600 hover:text-primary-800 dark:text-primary-400 dark:hover:text-primary-300 hover:bg-primary-50 dark:hover:bg-primary-900/20 rounded-lg transition-colors" title="{{ __('app.edit') }}">
                                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                                        </svg>
                                                    </a>
                                                    <form action="{{ route('vps.destroy', $natVps) }}" method="POST" class="inline" onsubmit="return confirm('{{ __('app.confirm_delete') }}')">
                                                        @csrf
                                                        @method('DELETE')
                            ...
                            @foreach($natVpsList as $natVps)
                                <div class="bg-surface-50 dark:bg-surface-700/50 rounded-xl p-4 border border-surface-200 dark:border-surface-600">
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        <form action="{{ route('vps.destroy', $natVps) }}" method="POST" class="flex-1" onsubmit="return confirm('{{ __('app.confirm_delete') }}')">
                                            @csrf
                                            @method('DELETE')
