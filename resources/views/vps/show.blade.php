<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
                ...
                @endif
                {{-- Console Button - Requirement 1.1 --}}
                <button 
                    type="button"
                                ...
                                <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                                    ...
                                    <div x-show="confirmAction"
                                        ...
                                        <div class="bg-gray-50 dark:bg-gray-700 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                            <form x-bind:action="'/vps/{{ $natVps->id }}/' + confirmAction" method="POST" class="inline">
                                                @csrf
                                                <button type="submit" 
                    ...
                    <div class="p-6">
                        ...
                        @if($natVps->user)
                            <div class="flex items-center justify-between p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                                ...
                                <form action="{{ route('vps.unassign', $natVps) }}" method="POST" onsubmit="return confirm('Are you sure you want to remove this user assignment?')">
                                    @csrf
                        ...
                        @else
                            <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                ...
                                <form action="{{ route('vps.assign', $natVps) }}" method="POST" class="flex items-end space-x-4">
                                    @csrf
                                    <div class="flex-1">
    ...
    <x-console-modal 
        :natVps="$natVps"
        :vncAvailable="!$apiOffline"
        :sshAvailable="!empty($natVps->ssh_username) && !empty($natVps->ssh_password)"
    />
</x-app-layout>
